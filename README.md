...
- 新增功能：推广时间段匹配推广后数据，并进行展示；

### v3.7.0(2025-05-17)

- 新增功能：通过飞书API导入产品推广数据；
- 功能优化：网站导航标签功能升级；
- 关键修复：修复各项网站错误信息；

### v3.6.8(2025-05-15)

- 新增功能：增加基金公司商务品维度数据图表的展示；

### v3.6.7(2025-05-14)

- 功能优化：进一步优化基金公司维度数据表的展示；
...
- 功能优化：新增基金公司商务品总规模和占比展示；

### v3.6.4(2025-05-12)

- 功能优化：实现基金公司维度数据表的排序功能；

### v3.6.3(2025-05-12)

- 关键修复：修复基金公司维度数据表展示中的bug；
...
- 新增功能：搜索基金公司时，展示每日加自选人数、每日持仓人数以及持仓价值的时序图

### v3.5.2(2025-04-16)

- 更新数据库：数据库纳入指数简介数据
- 关键修复：搜索ETF代码/指数后展示指数简介

### v3.5.1(2025-04-16)

- 功能优化：优化日涨幅top20数据展示表格

### v3.5.0(2025-04-16)

- 关键修复：恢复推荐栏中日涨幅top20数据
...
- 关键修复：修复etf_price、etf_price_history数据库缺少的数据、清理多余的数据表

### v3.4.3(2025-04-14)

- 关键修复：修复etf_info、etf_info_history数据库缺少的数据

### v3.4.2(2025-04-14)

- 关键修复：修复etf_info、etf_attention数据库缺少的数据
...
- 关键修复：修复搜索表格错误的数据来源
- 功能优化：数据展示优化
- 术语统一：将"持仓金额"统一修改为"持仓价值"，确保全系统术语一致性
...
- 新增功能：搜索证券代码时，展示每日加自选人数、每日持仓人数以及持仓价值的时序图
